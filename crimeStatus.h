...
public:
    ...
    Filter(QWidget *parent = nullptr) : QWidget(parent)
    {
        ...
        sortResult->setGeometry(0, 128, 1150, 400);
...
public:
    ...
    CaseStatusPage(bool isAdmin) : QWidget(nullptr)
    {
        ...
        back = new BackButton(25,480,270,40,this);
        ...
        stack->addWidget(filterPage);
        stack->addWidget(updatePage);
