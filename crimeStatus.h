        ...
        QObject::connect(saveButton, &QPushButton::clicked, [this]()
            {
                ...
                FileHandler::appendLog
                    (
                        ...
                        .arg(currentCaseID, selectedStatus)
                    );
            }
        );
...
public:
    ...
    explicit CaseStatusPage(bool isAdmin) : QWidget(nullptr)
    {
        ...
        pageBackground = UI::setupBackground(this, "backgroundThree.png");

        UI::setupSidebar(this, "[ CASE STATUS ]");
        
        UI::setupPageHeader(this, "CASE STATUS MANAGEMENT", "Track and update the resolution progress of all criminal cases");
