...
public:
    ViewCourt(QWidget *parent = nullptr) : QWidget(parent)
    {
        ...
        refresh = new Button("REFRESH", 980, 6, 140, 32, this);

        viewCard = new QLabel(this);
        viewCard->setGeometry(0, 50, 1150, 500);
...
public:
    ...
    {
        filterCard = new Card(50, 0, 1000, 110, this);

        QLabel *heading = new QLabel("FILTER BY COURT STATUS", this);
        heading->setGeometry(60, 18, 600, 28);
        heading->setStyleSheet
        (
            MONO +
            "font-size : 15px;"
        ...
        line->setGeometry(60, 52, 950, 1);
        line->setStyleSheet("background : rgba(0, 200, 255, 0.20);");

        ongoingButton = new Button("  ONGOING", 60, 64, 180, 40, this);
        onHoldButton  = new Button("  ON HOLD", 400, 64, 180, 40, this);
        verdictButton = new Button("  VERDICT REACHED", 820, 64, 210, 40, this);
        ...
        filterResult->setGeometry(0, 120, 1150, 425);
    ...
    void    setDisplayText(const QString &text)
    {
        filterResult->setText(text);
    }
    Button *getOngoingButton()
    {
        return ongoingButton;
    }
    Button *getOnHoldButton()
    {
        return onHoldButton;
    }
    Button *getVerdictButton()
    {
...
public:
    ...
    UpdateCourt(QWidget *parent = nullptr) : QWidget(parent)
    {
        ...
        infoLabel->setGeometry(20, 140, 660, 22);
        ...
        {
            infoLabel->setText("  Loading record...");
        });
    ...
    QPushButton *getOnHoldButton()
    {
        return onHoldButton;
    }
    QPushButton *getVerdictButton()
    {
        return verdictButton;
    }
...
public:
    ...
    AddCourt(QWidget *parent = nullptr) : QWidget(parent)
    {
        ...
        clearButton = new Button("CLEAR", 550, 368, 120, 44, this);
    ...
    QString getAccused() const
    {
        return accusedBox->text().trimmed();
    }
    QString getCrimeType() const
    {
        return crimeBox->text().trimmed();
    }
...
public:
    ...
    ViewCourt   *getViewPanel()
    {
        return panelView;
    }
    FilterCourt *getFilterPanel()
    {
        return panelFilter;
    }
    UpdateCourt *getUpdatePanel()
    {
        return panelUpdate;
    }
    AddCourt *getAddPanel()
    {
        return panelAdd;
    }

    void setOngoingCount(int n)
    {
        ongoingNumber->setText(QString::number(n));
    }
    void setOnHoldCount(int n)
    {
        onHoldNumber->setText(QString::number(n));
    }
    void setVerdictCount(int n)
    {
        verdictNumber->setText(QString::number(n));
    }
};
